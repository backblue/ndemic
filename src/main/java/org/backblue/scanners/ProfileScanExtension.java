...
public final class ProfileScanExtension extends ListenerAdapter {
    ...
    public void onButtonInteraction(@NonNull ButtonInteractionEvent event) {
        ...
        if (map.containsKey(id)) {
            ...
            if (action.equals("kick")) ezpunish.ezPunish(member, event.getMember(), List.of("ezpunish:profile"), false, member.getEffectiveAvatarUrl(), null);
            if (action.equals("ban")) ezpunish.ezPunish(member, event.getMember(), List.of("ezpunish:profile"), true, member.getEffectiveAvatarUrl(), null);
